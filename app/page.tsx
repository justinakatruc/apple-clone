      ...
      <div className={`h-lvh flex flex-col items-center transition-opacity duration-500 ${fadeIn ? "opacity-100" : "opacity-0"}`}>
        ...
        <div className={`h-full flex flex-col items-center gap-12 duration-500 ${showItems && "blur-xs"}`}>
          <div className="bg-gray-100">
            This is the main content of the page. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cumque unde deserunt architecto, aut ut ad vero error rem nam sed magni atque nesciunt commodi a delectus illum ipsa odit earum nisi ullam, doloribus sint? Impedit necessitatibus temporibus, nihil harum hic eveniet aspernatur aut reprehenderit quidem eligendi aliquam blanditiis est consequuntur consectetur enim itaque dicta provident magnam iusto atque qui autem rerum excepturi rem? Dolores eius laudantium rem magni, ratione iure. Delectus, sit praesentium aspernatur in sequi minus incidunt esse at! Laboriosam quidem minima tempora magnam dignissimos modi laborum consequatur, maxime blanditiis sapiente? Rem minima facere earum ea quisquam obcaecati deserunt eligendi nam, voluptate sunt molestiae dolores expedita dolor assumenda architecto alias fugit recusandae! Ratione voluptatibus quas necessitatibus nesciunt adipisci quibusdam labore repellendus enim dolores et pariatur dolorum, ipsa exercitationem id ab distinctio inventore eius asperiores incidunt quidem consequuntur hic. Suscipit doloribus voluptatum dolore fugit inventore, delectus incidunt impedit aperiam dicta? Hic numquam pariatur repellat velit explicabo eius fugiat commodi culpa saepe minus debitis maiores corrupti accusamus alias iusto nobis suscipit, quasi est dolorem vitae sed, asperiores laborum adipisci! Quam aliquid sed vel quas possimus eveniet alias veritatis consequuntur tenetur doloremque eum totam, accusamus aliquam pariatur neque temporibus? Vitae, quae aspernatur?
          </div>
          <div className="container ">
